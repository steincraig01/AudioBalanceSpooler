object Form1: TForm1
  ...
  object memLoginHtml: TMemo
    ...
    Lines.Strings = (
      ...
      '      top: 15px;'
      '      width: 78px;'
      '      transform-origin: 50.6752px 230.3px '
      '0px;'
      '    }'
      '    .gwd-p-vfd4 {'
      '      font-family: Arial;'
      ...
      'method="POST">'
      '    <svg data-gwd-shape="rectangle" '
      'id="rect" background="transparent" '
      'class="gwd-rect-1uz2">'
      '    <p class="gwd-button-'
      '1puc">Login</p>'
      '    <p class="gwd-p-'
      'vfd4">Username:</p>'
      '    <input type="text" id="edtUN" '
      'class="gwd-input-1b3i" data-gwd-'
      'name="UN">'
      '    <p class="gwd-p-'
      '1puq">Password:</p>'
      '    <input type="password" '
      'id="edtPassword" name="Password" '
      'class="gwd-input-16ic">'
      '    <button type="submit" id="btnLogin" '
      'name="Login" class="gwd-button-'
      'rew3">Login</button>   '
      '    </svg>'
      '  </form>'
      '</body>'
